...
public class NursingActivity extends Activity {
	...
	TableLayout tl;
	TableRow tr;
	TextView label,tv_email_address;
	Button btn_change_setting;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		tv_email_address = (TextView) findViewById(R.id.tv_email_address);
		tv_email_address.setText(LoginActivity.EmailAddress);
		
		btn_change_setting = (Button) findViewById(R.id.btn_change_setting);
